...
@section("title", "SEX DOLL - X DOLL KISS")
@section('description')
    <meta name="description" content="X DOLL KISS">
@endsection
<!------------------------------------- Underwears page content start-------------------------------------->
@section('content')
<div class="page-content">
    <!------------------------------------- Underwears page slider start-------------------------------------->
    ...
    <!------------------------------------- Underwears page body end -------------------------------------->



</div>
@endsection
<!------------------------------------- Underwears page content end-------------------------------------->
