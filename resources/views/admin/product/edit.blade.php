...
<!------------------------------------- admin product start -------------------------------------->
    ...
    <section class="content">
        <div class="container">
            <form class="form-horizontal" action="{{ route('admin.product.update') }}" method="POST" enctype="multipart/form-data" >
                @csrf
                                    ...
                                    <div class="text-center">
                                        <label class="btn btn-secondary active">
                                            <img class="profile-user-img img-fluid img-circle"
                                                ...
                                                <h5 class="text-center">Add New Main Product</h5>
                                                ...
                                                @else
                                                    <input type="radio" value="menu_mainproduct" name="productmenu" id="mainproduct" autocomplete="off" >
                                                @endif
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="text-center">
                                        <label class="btn btn-secondary">
                                            <img class="profile-user-img img-fluid img-circle"
                                                ...
                                                @if($product->productmenu == "menu_accessory" )
                                                    <input type="radio" value="menu_accessory" name="productmenu" id="accessory"  autocomplete="off" checked >
                                                @else
                                    ...
                                    <div class="text-center">
                                        <label class="btn btn-secondary">
                                            <img class="profile-user-img img-fluid img-circle"
                                                ...
                                                @if($product->productmenu == "menu_toys")
                                                <input type="radio" value="menu_toys" name="productmenu" id="toys" autocomplete="off" checked >
                                                @else
                                    ...
                                    <div class="text-center">
                                        <label class="btn btn-secondary">
                                            <img class="profile-user-img img-fluid img-circle"
                                                ...
                                                @if($product->productmenu == "menu_underwear")
                                                    <input type="radio" value="menu_underwear" name="productmenu" id="underwear"  autocomplete="off" checked>
                                                @else
                    ...
                    <div class="col-lg-12 d-flex justify-content-center">
                        ...
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-secondary active mr-2">
                                ...
                                @else
                                <input type="radio" value="female" name="productgender" id="female" autocomplete="off"> Female
                                @endif
                             </label>
                            <label class="btn btn-secondary">
                                <i class="fas fa-male"></i>
                                @if ($product->productgender == "male")
                                    <input type="radio" value="male" name="productgender" id="male" autocomplete="off" checked> Male
                                @else
                    ...
                    <div class="col-lg-12">
                        <div class="card card-secondary card-outline">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="text-center">
                                                    ...
                                                    <img   src="{{ asset('/') }}{{ $product->productpicture1 }}" alt="{{ $product->productname }}">
                                                    <h5>Picture 1</h5>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="text-center">
                                                    ...
                                                    <img src="{{ asset('/') }}{{ $product->productpicture2 }}" alt="{{ $product->productname }}">
                                                    <h5>Picture 2</h5>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="text-center">
                                                    ...
                                                    <img src="{{ asset('/') }}{{ $product->productpicture3 }}" alt="{{ $product->productname }}">
                                                    <h5>Picture 3</h5>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group row">
                                    <label for="shop_id" class="col-sm-2 col-form-label">Shop Name</label>
                                    <div class="col-md-6">
                                        <select class="form-control" name="shop_id">
                                            <option  value="{{ $product->shop_id}}" selected="selected">{{ $shopname}}</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" value="{{$product->productname}}" type="text" name="productname" placeholder="Product Name" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" value="{{$product->productprice}}" type="number" name="productprice" placeholder="Product Price" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" value="{{$product->previousprice}}" type="number" name="previousproductprice" placeholder="Previous Price">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" value="{{$product->producturl}}" type="url" name="producturl" placeholder="Product Url" required>
                                    </div>
                                </div>
