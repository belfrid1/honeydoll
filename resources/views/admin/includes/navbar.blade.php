<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('admin.shop.list') }}" class="nav-link">Shops</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('admin.criteria.list') }}" class="nav-link">Criteria</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('admin.product.list') }} " class="nav-link">Products</a>
        </li>
        {{-- <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('admin.product.assigned')}}" class="nav-link">Product Assigned</a>
        </li> --}}
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('admin.group.list') }}" class="nav-link">Group Products</a>
        </li>
    </ul>
